<div class="table-div">
    ...
    <table>
        <caption><strong>Transportes</strong></caption>
        <thead class="tab-line">
            <tr>
                <th colspan="6" rowspan="2">Transporte Utilizado</th>
        ...
        <tbody>
            ...
            @foreach($report_global['typesTransportsTotal'] as $transportName => $values)
            @if($values['total'] > 0)
                <tr>
                    <th colspan="6">{{ $transportName }}</th>
