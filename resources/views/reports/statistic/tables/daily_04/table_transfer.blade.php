    <div class="table-div">
        ...
        <table>
            <caption><strong>Transferências</strong></caption>
            <thead class="tab-line">
                <tr>
                    <th colspan="6" rowspan="2">Unidade de Transferência</th>
            ...
            <tbody>
                ...
                @foreach($report_global['destinyTransferTotal'] as $destinyName => $values)
                @if($values['total'] > 0)
                    <tr>
                        <th colspan="6">{{ $destinyName }}</th>
