            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @for($i = 1 ; $i <= 31 ; $i++)
                            <td colspan="1">
                                @if(isset($report['usa01_exits'][$i]))
                                    {{ $report['usa01_exits'][$i] }} 
                                @endif</td>
                        @endfor
                        <td colspan="2">{{ $report['usa01_exits']['total'] }}</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        @for($i = 1 ; $i <= 31 ; $i++)
                            <td colspan="1">
                                @if(isset($report['usa01_transfer'][$i]))
                                    {{ $report['usa01_transfer'][$i] }} 
                                @endif</td>
                        @endfor
                        <td colspan="2">{{ $report['usa01_transfer']['total'] }}</td>
                    </tr>
                    <tr>
                        <td colspan="3">Médico Clínico
                            225125</td>
