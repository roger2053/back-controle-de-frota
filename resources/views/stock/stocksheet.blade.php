...
<body>
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td colspan="2" height="20" align="left">Produto</td>
                    <td colspan="10" height="20" >{{ $params->stock->product_name }}</td>
                </tr>
                <tr>
                    <td colspan="2" height="20" align="left">Código de Barras</td>
                    <td colspan="10" height="20">{{ $params->stock->barcode }}</td>
                </tr>
                <tr>
                    <td colspan="2" height="20" align="left">Referência</td>
                    <td colspan="10" height="20">{{ $params->stock->reference }}</td>
                </tr>
            </tbody>
        </table>
        <table>
            <thead class="tab-color">
                <tr class="table-header">
                    <th colspan="12" height="20" class="tab-color2">Quantidade</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <th colspan="12" height="50">{{ $params->quantity_withdrawn }}</th>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <th colspan="4" height="200">
                        {{ !empty($params->name) ? $params->name : '' }} <br> <span style="padding-right: 5px">CPF:
