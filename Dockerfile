# ---------------------------------------------- Build Time Arguments --------------------------------------------------
    ...
    # ======================================================================================================================
    #                                                   --- Base ---
    # ---------------  This stage installs needed extensions, plugins, and adds all needed configurations  ---------------
    # ======================================================================================================================
    ...
    # Adiciona bash, nodejs, npm e dependências necessárias para as extensões intl e zip
    RUN apk add --update --no-cache \
        ...
        && apk del icu-dev libzip-dev oniguruma-dev autoconf gcc g++ make \
    ...
    # ------------------------------------------------- Install npm --------------------------------------------------------
    # (Nenhuma alteração necessária aqui, já que npm já está instalado)
    ...
    RUN mkdir -p public/docs/asset

    RUN cd public/docs/asset && \
        wget https://cdn.jsdelivr.net/npm/swagger-ui-dist@3/swagger-ui.css && \
        wget https://cdn.jsdelivr.net/npm/swagger-ui-dist@3/swagger-ui-bundle.js && \
        wget https://cdn.jsdelivr.net/npm/swagger-ui-dist@3/swagger-ui-standalone-preset.js && \
        wget https://cdn.jsdelivr.net/npm/swagger-ui-dist@3/favicon-32x32.png && \
        wget https://cdn.jsdelivr.net/npm/swagger-ui-dist@3/favicon-16x16.png
